 ...
 * Generated at: 2022-02-12 22:36:47 UTC
...
public final class signup_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        }\r\n");
      out.write("        .kboard-attr-row {\r\n");
      out.write("            width: 600px;\r\n");
      out.write("            margin: 0px auto;\r\n");
      out.write("            display: flex;\r\n");
      out.write("        }\r\n");
      out.write("        .kboard-attr-row > textarea {\r\n");
      ...
      out.write("        }\r\n");
      out.write("        #next > div:nth-child(3) {\r\n");
      ...
      out.write("           <form method=\"POST\" action=\"/team3/member/signupok.do\">\r\n");
      out.write("                <div class=\"box\">\r\n");
      out.write("                    * 필수 정보\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"box\">\r\n");
      out.write("                    <div class=\"box1\"><i class=\"far fa-keyboard\"></i></div>\r\n");
      out.write("                    <input type=\"text\" class=\"box2\" placeholder=\"아이디\" id=\"idin\" name=\"signid\" required>\r\n");
      out.write("                    <div class=\"box3\" id=\"idtxt\"></div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"box\">\r\n");
      out.write("                    <div class=\"box1\"><i class=\"fas fa-key\"></i></div>\r\n");
      out.write("                    <input type=\"password\" class=\"box2\" placeholder=\"비밀번호\" id=\"pwin\" name=\"signpw\" required>\r\n");
      out.write("                    <div class=\"box3\" id=\"pwbox\"></div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"box\">\r\n");
      out.write("                    <div class=\"box1\"><i class=\"fas fa-key\"></i></div>\r\n");
      out.write("                    <input type=\"password\" class=\"box2\" placeholder=\"비밀번호 확인\" id=\"pwinck\" required>\r\n");
      out.write("                    <div class=\"box3\" id=\"pwtxt\"></div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"box\">\r\n");
      out.write("                    <div class=\"box1\"><i class=\"fas fa-signature\"></i></div>\r\n");
      out.write("                    <input type=\"text\" class=\"box2\" placeholder=\"이름\" name=\"signname\" required>\r\n");
      out.write("                    <div class=\"box3\"></div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"box\">\r\n");
      out.write("                    <div class=\"box1\"><i class=\"fas fa-phone\"></i></div>\r\n");
      out.write("                    <input type=\"text\" class=\"box2\" placeholder=\"휴대폰번호 '-' 없이 입력\" name=\"signtel\" required>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"box\">\r\n");
      out.write("                    <div class=\"box1\"><i class=\"far fa-envelope-open\"></i></div>\r\n");
      out.write("                    <input type=\"text\" class=\"box2\" placeholder=\"이메일\" name=\"signemail1\" required>\r\n");
      out.write("                    <p id=\"email\">@</p>\r\n");
      out.write("                    <input type=\"text\" class=\"box3\" id=\"mailin\" name=\"signemail2\" required>\r\n");
      out.write("                    <div id=\"box4\">\r\n");
      out.write("                        <fieldset>\r\n");
      out.write("                            <select name=\"speed\" id=\"speed\">\r\n");
      ...
      out.write("    </div>\r\n");
      out.write("    <script>\r\n");
      out.write("       $('#idin').keyup(function() {\r\n");
      out.write("           if($('#idin').val().length >= 6) {\r\n");
      out.write("               $('#idtxt').text('사용가능합니다.');\r\n");
      out.write("               $('#idtxt').css('color', 'cornflowerblue');\r\n");
      out.write("           } else {\r\n");
      out.write("               $('#idtxt').text('최소 6자 이상 입력해주세요.');\r\n");
      out.write("               $('#idtxt').css('color', 'tomato');\r\n");
      out.write("           }\r\n");
      out.write("       });\r\n");
      out.write("   \r\n");
      out.write("       $('#pwin').keyup(function() {\r\n");
      out.write("           if($('#pwin').val().length >= 8 && $('#pwin').val().length <= 15) {\r\n");
      out.write("               $('#pwbox').text('사용가능합니다.');\r\n");
      out.write("               $('#pwbox').css('color', 'cornflowerblue');\r\n");
      out.write("           } else {\r\n");
      out.write("               $('#pwbox').text('비밀번호는 8~15자 이내로 입력해주세요.');\r\n");
      out.write("               $('#pwbox').css('color', 'tomato');\r\n");
      out.write("           }\r\n");
      out.write("       });\r\n");
      out.write("       \r\n");
      out.write("       $('#ju').keyup(function() {\r\n");
      out.write("           console.log($('#ju').val().length);\r\n");
      out.write("           if($('#ju').val().length==6) {\r\n");
      out.write("               $('#ju1').focus();\r\n");
      out.write("           }\r\n");
      out.write("       });\r\n");
      out.write("       \r\n");
      out.write("       $('#pwinck').keyup(function() {\r\n");
      out.write("           if($('#pwin').val() == $('#pwinck').val()) {\r\n");
      out.write("               $('#pwtxt').css('color', 'cornflowerblue');\r\n");
      out.write("               $('#pwtxt').text('일치합니다.');\r\n");
      out.write("           } else {\r\n");
      out.write("   \r\n");
      out.write("               $('#pwtxt').css('color', 'tomato');\r\n");
      out.write("               $('#pwtxt').text('일치하지않습니다.');\r\n");
      out.write("           }\r\n");
      out.write("       });\r\n");
      out.write("   \r\n");
      out.write("       $('#speed').change(function() {\r\n");
      out.write("           if($('select[name=speed]').val() != '직접입력') {\r\n");
      out.write("   \r\n");
      out.write("               $('#mailin').val($('select[name=speed]').val());\r\n");
      out.write("              \r\n");
      out.write("               console.log($('select[name=speed]').val());\r\n");
      out.write("           } else {\r\n");
      out.write("               $('#mailin').val('');\r\n");
      out.write("               $('#mailin').focus();\r\n");
      out.write("           }\r\n");
      out.write("       });\r\n");
      out.write("       \r\n");
      ...
      out.write("                   document.getElementById(\"detailedAddress\").focus();\r\n");
      out.write("               }\r\n");
      out.write("           }).open();\r\n");
      out.write("       }\r\n");
      out.write("    </script>\r\n");
